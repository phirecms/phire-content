...
class ContentController extends AbstractController
{
    ...
    public function add($tid)
    {
        ...
        $fields[0]['publish_date']['value'] = date($this->application->module('phire-content')->config['date_format']);
        $fields[0]['publish_time']['value'] = date($this->application->module('phire-content')->config['time_format']);
    ...
    public function edit($tid, $id)
    {
        ...
        $content = new Model\Content();
        $content->date_format = $this->application->module('phire-content')->config['date_format'];
        $content->time_format = $this->application->module('phire-content')->config['time_format'];
        $content->getById($id);
